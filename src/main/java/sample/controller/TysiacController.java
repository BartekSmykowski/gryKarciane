...
public class TysiacController {
    ...
    public Label nameOfPlayerWhoseTurnIsLabel;
    ...
    public void switchToGameChooseScene() throws Exception {
        ...
        root = FXMLLoader.load(getClass().getResource("/gameChooseScene.fxml"));
    ...
    void setGame(Game game){
        ...
        for(int i = 0; i < game.getNumberOfPlayers(); i++) {
            ...
            scoreTextFields[i].setOnAction(c->nextRound());
        ...
        nameOfPlayerWhoseTurnIsLabel.setText(game.getName(game.getWhoseTurn()));
    }
